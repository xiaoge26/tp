...
public class Ui {
    ...
    public void showHelp() {
        ...
        System.out.println("set-save-goal <amount> <date in dd-mm-yyyy format>: sets a saveGoal of <amount> until <date>");
        ...
        System.out.println("delete <account username>: deletes the account with username <account username>");
        System.out.println("set-wl <amount>: sets <amount> to be the withdrawal limit");
        System.out.println("check-wl: shows the withdrawal limit and the amount of money withdrawn this month");
